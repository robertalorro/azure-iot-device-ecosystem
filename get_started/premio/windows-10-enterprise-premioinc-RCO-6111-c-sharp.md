...
device: RCO-6111 Industrial Computer
language: csharp
---

Run a simple Csharp sample on RCO-6111 Industrial Computer device running Windows 10 Enterprise LTSC
===
---
...
This document describes how to connect RCO-6111 Industrial Computer device running Windows 10 Enterprise LTSC with Azure IoT SDK. This multi-step process includes:
...
-   RCO-6111 Industrial Computer device.


<a name="PrepareDevice"></a>
# Step 2: Prepare your Device

-   After powering up your RCO-6111 Industrial Computer device, be sure that it has established a network connection whether it is through ethernet, Wi-Fi, or cellular.
