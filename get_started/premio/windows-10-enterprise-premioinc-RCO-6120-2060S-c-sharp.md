...
device: RCO-6120-2060S GPU Computer
language: csharp
---

Run a simple Csharp sample on RCO-6120-2060S GPU Computer device running Windows 10 Enterprise LTSC
===
---
...
This document describes how to connect RCO-6120-2060S GPU Computer device running Windows 10 Enterprise LTSC with Azure IoT SDK. This multi-step process includes:
...
-   RCO-6120-2060S GPU Computer device.


<a name="PrepareDevice"></a>
# Step 2: Prepare your Device

-   After powering up your RCO-6120-2060S GPU Computer device, be sure that it has established a network connection whether it is through ethernet, Wi-Fi, or cellular.
