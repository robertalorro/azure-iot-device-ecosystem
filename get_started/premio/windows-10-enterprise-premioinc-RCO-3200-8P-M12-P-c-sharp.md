...
device: RCO-3200-8P-M12-P Rugged Edge Computer
language: csharp
---

Run a simple Csharp sample on RCO-3200-8P-M12-P Rugged Edge Computer device running Windows 10 Enterprise LTSC
===
---
...
This document describes how to connect RCO-3200-8P-M12-P Rugged Edge Computer device running Windows 10 Enterprise LTSC with Azure IoT SDK. This multi-step process includes:
