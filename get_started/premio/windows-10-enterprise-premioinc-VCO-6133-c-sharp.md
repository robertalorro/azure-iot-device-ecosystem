...
device: VCO-6133 Machine Vision Computer
language: csharp
---

Run a simple Csharp sample on VCO-6133 Machine Vision Computer device running Windows 10 Enterprise LTSC
===
---
...
This document describes how to connect VCO-6133 Machine Vision Computer device running Windows 10 Enterprise LTSC with Azure IoT SDK. This multi-step process includes:
...
-   VCO-6133 Machine Vision Computer device.


<a name="PrepareDevice"></a>
# Step 2: Prepare your Device

-   After powering up your VCO-6133 Machine Vision Computer device, be sure that it has established a network connection whether it is through ethernet, Wi-Fi, or cellular.
